...
> [!IMPORTANT]
> **Model Compatibility:** Do not confuse this board with the **ESP32-S3-LCD-1.47** or **ESP32-C6-LCD-1.47** (board versions without touch panel). Those Boards uses the **ST7789** driver, which is already supported by the ESPHome ILI9xxx TFT display component.
